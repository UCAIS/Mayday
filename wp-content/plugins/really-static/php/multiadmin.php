...
if( $_POST ["multidonate"]!=""){
	...
	if (substr ( $get, 0, 1 ) == "1") {
		update_site_option ( 'realstaticdonationid', substr ( $get, 1 ) );
	} else {
...
//
	...
	';
#if(multiloaddaten("realstaticdonationid")=="")echo 'strID="#rs_start";';
...
if(multiloaddaten("realstaticdonationid")!="-" and multiloaddaten("realstaticdonationid")!="")echo __('About', 'reallystatic');
else{
if(multiloaddaten("realstaticdonationid")=="" or multiloaddaten("realstaticdonationid")=="-")echo __('<font color="red">please</font> ', 'reallystatic');
 echo ''.__('Donate', 'reallystatic').'';
 }
echo '</a></li></ul>';
echo '<div class="rstatic_panel" id="rs_donate">';
global $reallystaticsystemmessage;
if(multiloaddaten("realstaticdonationid")==""|| multiloaddaten("realstaticdonationid")=="-")echo '<form method="post"><input type="hidden" name="strid2" value="rs_donate" /><font color="red">'.$reallystaticsystemmessage.'</font>
...
<img alt="" border="0" src="https://www.paypal.com/'.$ll.'/i/scr/pixel.gif" width="1" height="1">
  ...
  '.testfornewversion();
  elseif(multiloaddaten("realstaticdonationid")!="-")echo "<h2>License</h2>".multiloaddaten("realstaticdonationid");
else{
